// @generated by tools/gen_entities.py from https://html.spec.whatwg.org/entities.json — do not edit by hand.
//
// The HTML named character references, all 2231 of them. The name is stored
...
/// The longest name in the table, which bounds the longest-match scan.
pub(crate) const LONGEST: usize = 32;
