...
const HINDI: &[(&str, &str)] = &[
    ...
    ("Theme", "रंग-रूप"),
    ("System follows whatever your desktop is set to", "सिस्टम आपके डेस्कटॉप की सेटिंग के अनुसार चलता है"),
    ("System", "सिस्टम"),
    ("Animation", "गति"),
    (
    ...
    ("Encryption at rest", "संग्रहित डेटा का कूटलेखन"),
    ("Where the key that protects this profile is kept", "इस प्रोफ़ाइल की कुंजी कहाँ रखी है"),
    ...
    ("A browser built from scratch, in India.", "शून्य से बनाया गया ब्राउज़र, भारत में।"),
